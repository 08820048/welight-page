...
import { exportMergedTheme } from '@welight/core'
import { themeMap, themeOptionsMap } from '@welight/shared'
...
const selectedViewTheme = ref<'default' | 'grace' | 'simple' | 'rainbow' | 'popart' | 'academic' | 'technews'>('default')
